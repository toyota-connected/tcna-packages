...
import 'package:webview_flutter_linux/src/legacy/webview_cef_widget.dart';
import 'package:webview_flutter_platform_interface/src/webview_flutter_platform_interface_legacy.dart';

import '../cef_webview_test.mocks.dart' show MockTestWebViewHostApi;
import '../test_cef_webview.g.dart';
import 'webview_cef_widget_test.mocks.dart';

@GenerateMocks(<Type>[
  cef_webview.FlutterAssetManager,
  cef_webview.WebSettings,
  cef_webview.WebStorage,
  cef_webview.WebView,
  cef_webview.WebResourceRequest,
  cef_webview.DownloadListener,
  WebViewCefJavaScriptChannel,
  cef_webview.WebChromeClient,
  cef_webview.WebViewClient,
...
void main() {
  ...
  group('WebViewCefWidget', () {
    ...
    late cef_webview.DownloadListener downloadListener;
    late cef_webview.WebChromeClient webChromeClient;

    late MockJavascriptChannelRegistry mockJavascriptChannelRegistry;

    late WebViewCefPlatformController testController;
    ...
    // Builds a CefWebViewWidget with default parameters.
    Future<void> buildWidget(
      ...
      await tester.pumpWidget(WebViewCefWidget(
        creationParams: creationParams ??
            CreationParams(
    ...
    testWidgets('WebViewCefWidget', (WidgetTester tester) async {
    ...
    group('CreationParams', () {
      ...
      testWidgets('javascriptChannelNames', (WidgetTester tester) async {
        ...
        final List<cef_webview.JavaScriptChannel> javaScriptChannels =
            verify(mockWebView.addJavaScriptChannel(captureAny))
                .captured
                .cast<cef_webview.JavaScriptChannel>();
    ...
    group('WebViewPlatformController', () {
      ...
      testWidgets('loadFlutterAsset', (WidgetTester tester) async {
        ...
        verify(mockWebView.loadUrl(
          'file:///cef_asset/flutter_assets/$assetKey',
          <String, String>{},
        ));
      });
    ...
    group('WebViewPlatformCallbacksHandler', () {
      testWidgets('onPageStarted', (WidgetTester tester) async {
        await buildWidget(tester);
        final void Function(cef_webview.WebView, String) onPageStarted =
          ...
          requestLoading: anyNamed('requestLoading'),
          urlLoading: anyNamed('urlLoading'),
        )).captured.single as void Function(cef_webview.WebView, String);
      ...
      testWidgets('onPageFinished', (WidgetTester tester) async {
        ...
        final void Function(cef_webview.WebView, String) onPageFinished =
            verify(mockWebViewProxy.createWebViewClient(
          onPageStarted: anyNamed('onPageStarted'),
      ...
      testWidgets('onWebResourceError from onReceivedError',
        ...
        final void Function(cef_webview.WebView, int, String, String)
          ...
          urlLoading: anyNamed('urlLoading'),
                ...
                cef_webview.WebView, int, String, String);

        onReceivedError(
          mockWebView,
          cef_webview.WebViewClient.errorAuthentication,
          'description',
          'https://google.com',
        );
      ...
      testWidgets('onWebResourceError from onReceivedRequestError',
        ...
        onReceivedRequestError(
          ...
          cef_webview.WebResourceError(
            errorCode: cef_webview.WebViewClient.errorUnsafeResource,
      ...
      testWidgets('onNavigationRequest from urlLoading',
        ...
        final void Function(cef_webview.WebView, String) urlLoading =
            verify(mockWebViewProxy.createWebViewClient(
          onPageStarted: anyNamed('onPageStarted'),
          onPageFinished: anyNamed('onPageFinished'),
          onReceivedError: anyNamed('onReceivedError'),
      ...
      group('JavascriptChannelRegistry', () {
        testWidgets('onJavascriptChannelMessage', (WidgetTester tester) async {
          ...
          final WebViewCefJavaScriptChannel javaScriptChannel =
              verify(mockWebView.addJavaScriptChannel(captureAny))
                  .captured
                  .single as WebViewCefJavaScriptChannel;
