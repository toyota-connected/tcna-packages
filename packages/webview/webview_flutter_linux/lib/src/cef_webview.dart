...
import 'cef_webview.g.dart';
import 'cef_webview_api_impls.dart';
import 'instance_manager.dart';

export 'cef_webview_api_impls.dart'
...
///
/// See https://developer.cef.com/reference/cef/webkit/GeolocationPermissions.Callback.
@immutable
...
/// An Cef View that displays web pages.
///
/// **Basic usage**
...
/// [Web-based content](https://developer.cef.com/guide/webapps).
///
...
class WebView extends View {
  ...
  /// execution.
  ///
  /// Compatibility note. Applications targeting Cef versions N or later,
...
///
/// See https://developer.cef.com/reference/cef/webkit/CookieManager.
class CookieManager extends JavaObject {
  ...
  static CookieManager get instance {
    CefWebViewFlutterApis.instance.ensureSetUp();
    return _instance;
  }
...
class WebSettings extends JavaObject {
  ...
  /// starting from KITKAT Cef version, changing the user-agent while
  ...
  /// controls are deprecated in Cef so it's recommended to set this to
  /// false.
  ...
  /// on-screen zoom controls are deprecated in Cef so it's recommended to
  ...
  /// still accessible using file:///cef_asset and file:///cef_res. The
  ...
  ///
  /// The default is 100. See https://developer.cef.com/reference/cef/webkit/WebSettings#setTextZoom(int)
...
class WebViewClient extends JavaObject {
  ...
  WebViewClient({
    ...
    @Deprecated('Only called on Cef version < 23.') this.onReceivedError,
    this.requestLoading,
    this.urlLoading,
  ...
  ///
  /// See https://developer.cef.com/reference/cef/webkit/WebViewClient#ERROR_AUTHENTICATION
  static const int errorAuthentication = -4;

  /// Malformed URL.
  ///
  /// See https://developer.cef.com/reference/cef/webkit/WebViewClient#ERROR_BAD_URL
  static const int errorBadUrl = -12;

  /// Failed to connect to the server.
  ///
  /// See https://developer.cef.com/reference/cef/webkit/WebViewClient#ERROR_CONNECT
  static const int errorConnect = -6;

  /// Failed to perform SSL handshake.
  ///
  /// See https://developer.cef.com/reference/cef/webkit/WebViewClient#ERROR_FAILED_SSL_HANDSHAKE
  static const int errorFailedSslHandshake = -11;

  /// Generic file error.
  ///
  /// See https://developer.cef.com/reference/cef/webkit/WebViewClient#ERROR_FILE
  static const int errorFile = -13;

  /// File not found.
  ///
  /// See https://developer.cef.com/reference/cef/webkit/WebViewClient#ERROR_FILE_NOT_FOUND
  static const int errorFileNotFound = -14;

  /// Server or proxy hostname lookup failed.
  ///
  /// See https://developer.cef.com/reference/cef/webkit/WebViewClient#ERROR_HOST_LOOKUP
  static const int errorHostLookup = -2;

  /// Failed to read or write to the server.
  ///
  /// See https://developer.cef.com/reference/cef/webkit/WebViewClient#ERROR_IO
  static const int errorIO = -7;

  /// User authentication failed on proxy.
  ///
  /// See https://developer.cef.com/reference/cef/webkit/WebViewClient#ERROR_PROXY_AUTHENTICATION
  static const int errorProxyAuthentication = -5;

  /// Too many redirects.
  ///
  /// See https://developer.cef.com/reference/cef/webkit/WebViewClient#ERROR_REDIRECT_LOOP
  static const int errorRedirectLoop = -9;

  /// Connection timed out.
  ///
  /// See https://developer.cef.com/reference/cef/webkit/WebViewClient#ERROR_TIMEOUT
  static const int errorTimeout = -8;

  /// Too many requests during this load.
  ///
  /// See https://developer.cef.com/reference/cef/webkit/WebViewClient#ERROR_TOO_MANY_REQUESTS
  static const int errorTooManyRequests = -15;

  /// Generic error.
  ///
  /// See https://developer.cef.com/reference/cef/webkit/WebViewClient#ERROR_UNKNOWN
  static const int errorUnknown = -1;

  /// Resource load was canceled by Safe Browsing.
  ///
  /// See https://developer.cef.com/reference/cef/webkit/WebViewClient#ERROR_UNSAFE_RESOURCE
  static const int errorUnsafeResource = -16;

  /// Unsupported authentication scheme (not basic or digest).
  ///
  /// See https://developer.cef.com/reference/cef/webkit/WebViewClient#ERROR_UNSUPPORTED_AUTH_SCHEME
  static const int errorUnsupportedAuthScheme = -3;

  /// Unsupported URI scheme.
  ///
  /// See https://developer.cef.com/reference/cef/webkit/WebViewClient#ERROR_UNSUPPORTED_SCHEME
...
///
/// Only supported on Cef versions >= 21.
///
...
class PermissionRequest extends JavaObject {
  ...
  ///
  /// See https://developer.cef.com/reference/cef/webkit/PermissionRequest#RESOURCE_AUDIO_CAPTURE.
  static const String audioCapture = 'cef.webkit.resource.AUDIO_CAPTURE';

  /// Resource will allow sysex messages to be sent to or received from MIDI
  /// devices.
  ///
  /// See https://developer.cef.com/reference/cef/webkit/PermissionRequest#RESOURCE_MIDI_SYSEX.
  static const String midiSysex = 'cef.webkit.resource.MIDI_SYSEX';

  /// Resource belongs to video capture device, like camera.
  ///
  /// See https://developer.cef.com/reference/cef/webkit/PermissionRequest#RESOURCE_VIDEO_CAPTURE.
  static const String videoCapture = 'cef.webkit.resource.VIDEO_CAPTURE';

  /// Resource belongs to protected media identifier.
  ///
  /// See https://developer.cef.com/reference/cef/webkit/PermissionRequest#RESOURCE_VIDEO_CAPTURE.
  static const String protectedMediaId =
      'cef.webkit.resource.PROTECTED_MEDIA_ID';
...
///
/// See https://developer.cef.com/reference/cef/webkit/WebChromeClient.FileChooserParams.
...
class WebResourceRequest {
  ...
  ///
  /// Only supported on Cef version >= 24.
...
/// Manages Flutter assets that are part of Cef's app bundle.
...
///
/// Wraps [WebStorage](https://developer.cef.com/reference/cef/webkit/WebStorage).
...
///
/// See https://developer.cef.com/reference/cef/webkit/WebChromeClient.CustomViewCallback.
