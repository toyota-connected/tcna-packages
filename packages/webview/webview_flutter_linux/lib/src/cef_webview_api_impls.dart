...
/// Handles initialization of Flutter APIs for Cef WebView.
class CefWebViewFlutterApis {
  /// Creates a [CefWebViewFlutterApis].
  CefWebViewFlutterApis({
  ...
  /// Mutable instance containing all Flutter Apis for Cef WebView.
  ///
  /// This should only be changed for testing purposes.
  static CefWebViewFlutterApis instance = CefWebViewFlutterApis();
