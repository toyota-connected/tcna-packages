...
import 'webview_cef_cookie_manager.dart';

/// Creates a [Widget] with a [cef_webview.WebView].
class WebViewCefWidget extends StatefulWidget {
  /// Constructs a [WebViewCefWidget].
  const WebViewCefWidget({
    super.key,
    ...
    @visibleForTesting
    this.flutterAssetManager = const cef_webview.FlutterAssetManager(),
  ...
  /// Handles callbacks that are made by [cef_webview.WebViewClient], [cef_webview.DownloadListener], and [cef_webview.WebChromeClient].
  final WebViewPlatformCallbacksHandler callbacksHandler;

  /// Manages named JavaScript channels and forwarding incoming messages on the correct channel.
  final JavascriptChannelRegistry javascriptChannelRegistry;

  /// Handles constructing [cef_webview.WebView]s and calling static methods.
  ///
  /// This should only be changed for testing purposes.
  final WebViewProxy webViewProxy;

  /// Manages access to Flutter assets that are part of the Cef App bundle.
  ///
  /// This should only be changed for testing purposes.
  final cef_webview.FlutterAssetManager flutterAssetManager;

  /// Callback to build a widget once [cef_webview.WebView] has been initialized.
  final Widget Function(WebViewCefPlatformController controller)
      onBuildWidget;

  /// Manages the JavaScript storage APIs.
  final cef_webview.WebStorage? webStorage;

  @override
  State<StatefulWidget> createState() => _WebViewCefWidgetState();
}

class _WebViewCefWidgetState extends State<WebViewCefWidget> {
  late final WebViewCefPlatformController controller;

  @override
  void initState() {
    super.initState();
    controller = WebViewCefPlatformController(
...
/// Implementation of [WebViewPlatformController] with the Cef WebView api.
class WebViewCefPlatformController extends WebViewPlatformController {
  /// Construct a [WebViewCefPlatformController].
  WebViewCefPlatformController({
    ...
    @visibleForTesting
    this.flutterAssetManager = const cef_webview.FlutterAssetManager(),
    @visibleForTesting cef_webview.WebStorage? webStorage,
  })  : webStorage = webStorage ?? cef_webview.WebStorage.instance,
  ...
  final Map<String, WebViewCefJavaScriptChannel> _javaScriptChannels =
      <String, WebViewCefJavaScriptChannel>{};
  ...
  late final cef_webview.WebViewClient _webViewClient =
    ...
    onPageStarted: withWeakReferenceTo(this, (
      WeakReference<WebViewCefPlatformController> weakReference,
    ) {
      return (_, String url) {
    ...
    requestLoading: withWeakReferenceTo(this, (
      ...
      return (_, cef_webview.WebResourceRequest request) {
        weakReference.target?._handleNavigationRequest(
          url: request.url,
  ...
  late final cef_webview.WebView webView;
  ...
  @visibleForTesting
  late final cef_webview.DownloadListener downloadListener =
      cef_webview.DownloadListener(
  ...
  /// Handles JavaScript dialogs, favicons, titles, new windows, and the progress for [cef_webview.WebView].
  @visibleForTesting
  late final cef_webview.WebChromeClient webChromeClient =
      cef_webview.WebChromeClient(
          onProgressChanged: withWeakReferenceTo(
    this,
    (WeakReference<WebViewCefPlatformController> weakReference) {
      return (_, int progress) {
        final WebViewCefPlatformController? controller =
  ...
  /// Receive various notifications and requests for [cef_webview.WebView].
  @visibleForTesting
  cef_webview.WebViewClient get webViewClient => _webViewClient;
  ...
  Future<void> loadRequest(
    ...
    throw UnimplementedError(
        'This version of webview_cef_widget currently has no '
  ...
  Future<void> addJavascriptChannels(Set<String> javascriptChannelNames) {
    return Future.wait(
      javascriptChannelNames.where(
        ...
        (String channelName) {
          final WebViewCefJavaScriptChannel javaScriptChannel =
              WebViewCefJavaScriptChannel(
  ...
  void _setCreationParams(CreationParams creationParams) {
    ...
    WebViewCookieManagerPlatform.instance ??= WebViewCefCookieManager();
...
class WebViewCefJavaScriptChannel
    extends cef_webview.JavaScriptChannel {
  /// Creates a [WebViewCefJavaScriptChannel].
  WebViewCefJavaScriptChannel(
    super.channelName,
...
class WebViewProxy {
  ...
  cef_webview.WebView createWebView() {
    return cef_webview.WebView();
  }

  /// Constructs a [cef_webview.WebViewClient].
  cef_webview.WebViewClient createWebViewClient({
    ...
    void Function(cef_webview.WebView webView,
            cef_webview.WebResourceRequest request)?
        requestLoading,
    void Function(cef_webview.WebView webView, String url)? urlLoading,
  }) {
    return cef_webview.WebViewClient(
