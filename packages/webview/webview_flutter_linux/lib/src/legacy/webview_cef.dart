...
/// Builds an Cef webview.
///
/// This is used as the default implementation for [WebView.platform] on Cef. It uses
/// an [CefView] to embed the webview in the widget hierarchy, and uses a method channel to
/// communicate with the platform code.
class CefWebView implements WebViewPlatform {
  /// Constructs an [CefWebView].
  CefWebView({@visibleForTesting InstanceManager? instanceManager})
    ...
    return WebViewCefWidget(
      ...
      onBuildWidget: (WebViewCefPlatformController controller) {
        return GestureDetector(
          ...
          // This is a temporary stop gap due to issues with text selection on Cef:
