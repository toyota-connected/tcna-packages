...
@ConfigurePigeon(PigeonOptions(
  dartOut: 'lib/src/cef_webview.g.dart',

  cppOptions: CppOptions(namespace: 'webview_flutter_linux_plugin'),
  cppHeaderOut: 'linux_cpp/messages.g.h',
  cppSourceOut: 'linux_cpp/messages.g.cpp',
...
enum FileChooserMode {
  ...
  /// user to pick it.
  ///
  /// See https://developer.cef.com/reference/cef/webkit/WebChromeClient.FileChooserParams#MODE_OPEN.
  open,

  /// Similar to [open] but allows multiple files to be selected.
  ///
  /// See https://developer.cef.com/reference/cef/webkit/WebChromeClient.FileChooserParams#MODE_OPEN_MULTIPLE.
  openMultiple,

  /// Allows picking a nonexistent file and saving it.
  ///
  /// See https://developer.cef.com/reference/cef/webkit/WebChromeClient.FileChooserParams#MODE_SAVE.
  save,
}

/// Indicates the type of message logged to the console.
///
/// See https://developer.cef.com/reference/cef/webkit/ConsoleMessage.MessageLevel.
enum ConsoleMessageLevel {
  /// Indicates a message is logged for debugging.
  ///
  /// See https://developer.cef.com/reference/cef/webkit/ConsoleMessage.MessageLevel#DEBUG.
  debug,

  /// Indicates a message is provided as an error.
  ///
  /// See https://developer.cef.com/reference/cef/webkit/ConsoleMessage.MessageLevel#ERROR.
  error,

  /// Indicates a message is provided as a basic log message.
  ///
  /// See https://developer.cef.com/reference/cef/webkit/ConsoleMessage.MessageLevel#LOG.
  log,

  /// Indicates a message is provided as a tip.
  ///
  /// See https://developer.cef.com/reference/cef/webkit/ConsoleMessage.MessageLevel#TIP.
  tip,

  /// Indicates a message is provided as a warning.
  ///
  /// See https://developer.cef.com/reference/cef/webkit/ConsoleMessage.MessageLevel#WARNING.
  warning,
