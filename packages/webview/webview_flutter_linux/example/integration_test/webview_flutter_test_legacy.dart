...
import 'package:webview_flutter_linux/src/cef_webview.dart' as cef;
...
import 'package:webview_flutter_linux/src/weak_reference_utils.dart';
import 'package:webview_flutter_linux/src/webview_flutter_cef_legacy.dart';
import 'package:webview_flutter_linux_example/legacy/navigation_decision.dart';
import 'package:webview_flutter_linux_example/legacy/navigation_request.dart';
import 'package:webview_flutter_linux_example/legacy/web_view.dart';
...
Future<void> main() async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      instanceManager =
        ...
        if (instance is cef.WebView && !webViewGCCompleter.isCompleted) {
          webViewGCCompleter.complete();
        }
      });

      cef.WebView.api = WebViewHostApiImpl(
        instanceManager: instanceManager,
      );
      cef.WebSettings.api = WebSettingsHostApiImpl(
        instanceManager: instanceManager,
      );
      cef.WebChromeClient.api = WebChromeClientHostApiImpl(
        instanceManager: instanceManager,
      );
      cef.WebViewClient.api = WebViewClientHostApiImpl(
        instanceManager: instanceManager,
      );
      cef.DownloadListener.api = DownloadListenerHostApiImpl(
        instanceManager: instanceManager,
      );
        ...
        await tester.pumpWidget(
          Builder(
            builder: (BuildContext context) {
              return CefWebView(instanceManager: instanceManager).build(
                context: context,
      ...
      cef.WebStorage.instance = cef.WebStorage();
    },
    skip: true,
  );
  ...
  group('SurfaceCefWebView', () {
    setUpAll(() {
      WebView.platform = SurfaceCefWebView();
    });
