...
class SampleMenu extends StatelessWidget {
  ...
  Future<void> _onVideoExample(BuildContext context) {
    final CefWebViewController cefController =
        webViewController as CefWebViewController;
    // #docregion fullscreen_example
    cefController.setCustomWidgetCallbacks(
    ...
    return cefController.loadRequest(
      LoadRequestParams(
