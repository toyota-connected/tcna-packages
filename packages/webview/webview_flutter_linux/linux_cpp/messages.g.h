...
class WebResourceRequestData {
 public:
  ...
  explicit WebResourceRequestData(
 ...
 private:
  static WebResourceRequestData FromEncodableList(const flutter::EncodableList& list);
...
class WebResourceResponseData {
 ...
 private:
  static WebResourceResponseData FromEncodableList(const flutter::EncodableList& list);
  flutter::EncodableList ToEncodableList() const;
  friend class InstanceManagerHostApi;
  friend class InstanceManagerHostApiCodecSerializer;
  friend class JavaObjectHostApi;
...
class WebResourceErrorData {
 ...
 private:
  static WebResourceErrorData FromEncodableList(const flutter::EncodableList& list);
  flutter::EncodableList ToEncodableList() const;
  friend class InstanceManagerHostApi;
  friend class InstanceManagerHostApiCodecSerializer;
  friend class JavaObjectHostApi;
...
class CookieManagerHostApi {
 public:
  ...
  virtual std::optional<FlutterError> AttachInstance(int64_t instance_identifier) = 0;
...
class WebViewHostApi {
 public:
  ...
  virtual std::optional<FlutterError> LoadData(
    int64_t instance_id,
  ...
  virtual std::optional<FlutterError> ClearCache(
    int64_t instance_id,
  ...
  virtual std::optional<FlutterError> ScrollTo(
    int64_t instance_id,
    int64_t x,
    int64_t y) = 0;
  virtual std::optional<FlutterError> ScrollBy(
    int64_t instance_id,
    int64_t x,
    int64_t y) = 0;
  ...
  virtual std::optional<FlutterError> SetWebContentsDebuggingEnabled(bool enabled) = 0;
...
class WebSettingsHostApi {
 public:
  ...
  virtual std::optional<FlutterError> SetDomStorageEnabled(
    int64_t instance_id,
    bool flag) = 0;
  ...
  virtual std::optional<FlutterError> SetSupportMultipleWindows(
    int64_t instance_id,
    bool support) = 0;
  virtual std::optional<FlutterError> SetJavaScriptEnabled(
    int64_t instance_id,
    bool flag) = 0;
  ...
  virtual std::optional<FlutterError> SetMediaPlaybackRequiresUserGesture(
    int64_t instance_id,
    bool require) = 0;
  virtual std::optional<FlutterError> SetSupportZoom(
    int64_t instance_id,
    bool support) = 0;
  virtual std::optional<FlutterError> SetLoadWithOverviewMode(
    int64_t instance_id,
    bool overview) = 0;
  virtual std::optional<FlutterError> SetUseWideViewPort(
    int64_t instance_id,
    bool use) = 0;
  ...
  virtual std::optional<FlutterError> SetBuiltInZoomControls(
    int64_t instance_id,
    bool enabled) = 0;
  virtual std::optional<FlutterError> SetAllowFileAccess(
    int64_t instance_id,
    bool enabled) = 0;
  virtual std::optional<FlutterError> SetTextZoom(
    int64_t instance_id,
    int64_t text_zoom) = 0;
...
class WebViewClientHostApi {
 public:
  ...
  virtual std::optional<FlutterError> Create(int64_t instance_id) = 0;
  virtual std::optional<FlutterError> SetSynchronousReturnValueForShouldOverrideUrlLoading(
    int64_t instance_id,
    bool value) = 0;
...
class WebViewClientFlutterApiCodecSerializer : public flutter::StandardCodecSerializer {
 public:
...
class WebChromeClientHostApi {
 public:
  ...
  virtual std::optional<FlutterError> Create(int64_t instance_id) = 0;
  virtual std::optional<FlutterError> SetSynchronousReturnValueForOnShowFileChooser(
    int64_t instance_id,
    bool value) = 0;
  virtual std::optional<FlutterError> SetSynchronousReturnValueForOnConsoleMessage(
    int64_t instance_id,
    bool value) = 0;
...
class FlutterAssetManagerHostApi {
 public:
  ...
  FlutterAssetManagerHostApi& operator=(const FlutterAssetManagerHostApi&) = delete;
  virtual ~FlutterAssetManagerHostApi() {}
  virtual ErrorOr<flutter::EncodableList> List(const std::string& path) = 0;
  virtual ErrorOr<std::string> GetAssetFilePathByName(const std::string& name) = 0;
...
class WebChromeClientFlutterApiCodecSerializer : public flutter::StandardCodecSerializer {
 public:
...
class CustomViewCallbackHostApi {
 public:
  ...
  CustomViewCallbackHostApi& operator=(const CustomViewCallbackHostApi&) = delete;
  virtual ~CustomViewCallbackHostApi() {}
  // Handles Dart method `CustomViewCallback.onCustomViewHidden`.
  virtual std::optional<FlutterError> OnCustomViewHidden(int64_t identifier) = 0;
...
class GeolocationPermissionsCallbackHostApi {
 public:
  GeolocationPermissionsCallbackHostApi(const GeolocationPermissionsCallbackHostApi&) = delete;
  GeolocationPermissionsCallbackHostApi& operator=(const GeolocationPermissionsCallbackHostApi&) = delete;
  virtual ~GeolocationPermissionsCallbackHostApi() {}
  // Handles Dart method `GeolocationPermissionsCallback.invoke`.
  virtual std::optional<FlutterError> Invoke(
    int64_t instance_id,
    const std::string& origin,
    bool allow,
    bool retain) = 0;
...
class GeolocationPermissionsCallbackFlutterApi {
 public:
  GeolocationPermissionsCallbackFlutterApi(flutter::BinaryMessenger* binary_messenger);
  static const flutter::StandardMessageCodec& GetCodec();
  // Create a new Dart instance and add it to the `InstanceManager`.
  void Create(
    int64_t instance_id,
...
class HttpAuthHandlerHostApi {
 public:
  ...
  virtual std::optional<FlutterError> Proceed(
    int64_t instance_id,
