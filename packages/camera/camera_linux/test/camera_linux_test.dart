...
import 'camera_linux_test.mocks.dart';
...
void main() {
  ...
  group('$CameraLinux()', () {
    test('registered instance', () {
      CameraLinux.registerWith();
      expect(CameraPlatform.instance, isA<CameraLinux>());
    });
    ...
    group('Creation, Initialization & Disposal Tests', () {
      test('Should send creation data and receive back a camera id', () async {
        ...
        final CameraLinux plugin = CameraLinux(api: mockApi);
      ...
      test(
        ...
        final CameraLinux camera = CameraLinux(api: mockApi);
    ...
    group('Event Tests', () {
      ...
      setUp(() async {
        ...
        when(mockApi.initialize(any))
            .thenAnswer((_) async => PlatformSize(width: 1920, height: 1080));
        plugin = CameraLinux(api: mockApi);
