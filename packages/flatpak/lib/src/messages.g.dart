...
class FlatpakApi {
  ...
  Future<void> setupEventChannel(String appId) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.flatpak_flutter.FlatpakApi.setupEventChannel$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
