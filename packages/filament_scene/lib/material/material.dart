  ...
  Map<String, dynamic> toJson() {
    ...
    if (type == MaterialType.texture) {
      if (value is Texture) {
        ...
        throw UnsupportedError("Type '${value.runtimeType} is not supported as a value for 'MaterialType.texture'");
      }
    } else {
      valueJson = value;
    }
